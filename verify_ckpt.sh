...
python evaluate_response_ckpt.py \
    --model_path="/home/zhaoyiz/projects/reasoning/verl/checkpoints/verl/qwen2.5-1.5b_gsm8k/global_step_75/actor/huggingface" \
    --response_path=$path \
    --task verify \
    --scale=1.5B \
    --result_name "gsm8k_verify_deepseek-1.5b_qwen2.5-1.5b"
# local_dir=.local_daman
# apptainer exec --nv -B $HOME/$local_dir:$HOME/.local --env-file  $HOME/containers/env.txt $HOME/containers/pytorch_23.11-py3.sif \
# python evaluate_response_ckpt.py \
